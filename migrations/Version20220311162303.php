 ...
 */
final class Version20220311162303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produits CHANGE photo photo VARCHAR(150) DEFAULT NULL');
    }
